...
function Navbar({ tuKhoaTimKiem, setTuKhoaTimKiem }: NavbarProps) {
  ...
  const handleOnKeyPress = (event: React.KeyboardEvent<HTMLInputElement>) => {
    // Khi người dùng ấn phím trong ô nhập liệu
    if (event.key === 'Enter') {
      setTuKhoaTimKiem(tuKhoaTamThoi)
    }
  }
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="container-fluid">
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown1">
                ...
                <li>
                  <NavLink className="dropdown-item" to="/4">
                    Thể loại 4
                  </NavLink>
                </li>
                <li>
                  <NavLink className="dropdown-item" to="/5">
                    Thể loại 5
                  </NavLink>
                </li>
              </ul>
        ...
        <div className="d-flex">
          ...
          />
          <button id="buttonSearch" className="btn btn-outline-success" type="button" onClick={handleSearch}>
            <Search />
          </button>
        </div>
